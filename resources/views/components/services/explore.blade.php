<section class="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-900 to-indigo-950 mb-20">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12 space-y-6">
            <!-- Badge -->
            <div
                class="nopage inline-flex items-center gap-2 bg-white text-indigo-900 px-5 py-2.5 rounded-full text-sm font-semibold uppercase tracking-wide">
        ...
        <!-- View All Button -->
        <div class="text-center mt-12 nopage">
            <a href="#"
