        ...
        <div class="flex items-center justify-between py-3">
            ...
            <div class="flex-shrink-0">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="Roofiant Exteriors" class="h-11 w-auto">
                </a>
            </div>
            ...
            <nav class="hidden lg:flex items-center space-x-8">
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <div class="py-2">
                            <a href="/projects" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Projects</a>
        ...
        <div class="container mx-auto px-4 py-4 space-y-4">
            ...
            <div>
                ...
                <div class="mobile-dropdown-content hidden pl-4 space-y-2 mt-2">
                    <a href="/projects" class="block text-gray-600 hover:text-blue-900 py-1">Projects</a>
