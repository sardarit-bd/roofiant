<x-dashboard-layout>
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Create Service</h2>
            <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Add a new service offering</p>
        </div>
    </div>
    ...
    <form action="{{ route('services.store') }}" method="POST" class="max-w-2xl">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 space-y-5">
                ...
                {{-- Name --}}
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1.5">
                ...
                {{-- Slug --}}
                <div>
                    <label for="slug" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1.5">
                        Slug
                        <span class="ml-1 text-xs font-normal text-gray-400 dark:text-gray-500">(auto-generated)</span>
                    </label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400 dark:text-gray-500 text-sm select-none pointer-events-none">
                            /services/
                        </span>
                        <input
                            type="text"
                            ...
                            class="w-full pl-20 pr-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-gray-700/50 border @error('slug') border-red-400 dark:border-red-500 @else border-gray-200 dark:border-gray-600 @enderror rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent font-mono transition"
                        />
                    </div>
            ...
            {{-- Info Card --}}
            <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl border border-indigo-100 dark:border-indigo-800 p-5">
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 text-indigo-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/>
                    </svg>
                    <div class="text-xs text-indigo-700 dark:text-indigo-300 space-y-1 leading-relaxed">
                        <p class="font-semibold text-sm mb-1">Quick Tips</p>
                        <p>Services can be linked to <strong>projects</strong> and <strong>areas</strong> after creation.</p>
