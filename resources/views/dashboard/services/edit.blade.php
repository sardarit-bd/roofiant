div<x-dashboard-layout>
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Edit Service</h2>
            <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Update service information</p>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form action="{{ route('services.update', $service) }}" method="POST" class="max-w-2xl">
        @csrf
        @method('PUT')
