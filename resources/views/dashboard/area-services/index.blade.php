<x-dashboard-layout>
    ...
    {{-- Page Header --}}
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-700">Area Services</h2>
            ...
            <table class="w-full text-sm text-left">
                ...
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        ...
                        <th class="px-6 py-4 font-semibold text-xs uppercase tracking-wider text-gray-500">Area</th>
                        <th class="px-6 py-4 font-semibold text-xs uppercase tracking-wider text-gray-500">Service</th>
                        <th class="px-6 py-4 font-semibold text-xs uppercase tracking-wider text-gray-500">Area Details
                        </th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-100">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="font-medium text-gray-800 hover:text-indigo-600 transition-colors">
