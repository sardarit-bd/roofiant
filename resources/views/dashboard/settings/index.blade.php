<x-dashboard-layout>
    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            ...
            <div id="general-tab" class="tab-content bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $settings->title) }}" required
                            ...
                            class="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" placeholder="A brief description of your website..."
                            class="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $settings->description) }}</textarea>
            ...
            <!-- Branding Tab -->
            <div id="branding-tab" class="tab-content hidden bg-white rounded-lg shadow-md p-6">
            ...
            <!-- Contact Info Tab -->
            <div id="contact-tab" class="tab-content hidden bg-white rounded-lg shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">
                    Contact Information
                </h3>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="3" placeholder="123 Main Street, Newark, OH 43055"
                            class="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('address', $settings->address) }}</textarea>
                    </div>
                </div>
            </div>

            <!-- SEO Tab -->
            <div id="seo-tab" class="tab-content hidden bg-white rounded-lg shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">
                    SEO Settings
                </h3>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="3"
                            ...
                            maxlength="160"
                            class="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('meta_description', $settings->meta_description) }}</textarea>
        ...
        <div class="mt-8 flex justify-end gap-4">
            <button type="reset"
                class="px-6 py-3 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors">
